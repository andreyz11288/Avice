...
<?php get_header(); ?>
                ...
                <div id="wrapper" class="" bis_skin_checked="1">
                  <div id="backgrounds" bis_skin_checked="1"><div class="back back0" bis_skin_checked="1"></div><div class="back back1 active" bis_skin_checked="1"></div>
                  <div class="back back2" bis_skin_checked="1"></div></div><div class="wow-cnt" bis_skin_checked="1"><main id="main"><section class="visual-section">
                    <div class="rotation-holder" bis_skin_checked="1"><div class="rotation" bis_skin_checked="1"><div style="transform: rotate(210deg);" bis_skin_checked="1"></div>
                  </div></div><div class="container" bis_skin_checked="1"><div class="col-holder" bis_skin_checked="1"><div class="col" bis_skin_checked="1">
                    ...
                    <a href="<?php echo get_home_url() ?>/contact" class="btn">Contact Us</a></div>
                  ...
                  <div class="mob-social" bis_skin_checked="1">
                    <ul class="social-icon">
                          <li><a href="https://www.facebook.com/aviceglobal/" target="_blank"><img alt="img" src="<?php bloginfo('template_url'); ?>/assets/img/face.svg"></a></li>
                          <li><a href="https://www.linkedin.com/company/aviceinc/?viewAsMember=true" target="_blank">
                            <img alt="img" src="<?php bloginfo('template_url'); ?>/assets/img/linkin.svg"></a></li>
                            <li><a href="https://twitter.com/AviceGlobal" target="_blank"><img alt="img" src="<?php bloginfo('template_url'); ?>/assets/img/twitter.svg"></a></li>
                            <li><a href="https://www.instagram.com/avice_global/" target="_blank"><img alt="img" src="<?php bloginfo('template_url'); ?>/assets/img/inst.svg"></a></li>
                          </ul></div></div><div class="left-bg-el" bis_skin_checked="1"></div></section>
                              ...
                              if( $myposts ){
                                ...
                                foreach( $myposts as $post ){
                                  ...
                                  <div class="col" bis_skin_checked="1">
                                    <div class="img-holder show-in fadeInUp 
                                    <?php if ($i === 2 || $i === 4) {echo 'delay500';}; ?>" bis_skin_checked="1">
      ...
      <div class="col" bis_skin_checked="1">
        ...
        <!-- <div class="slide" bis_skin_checked="1">
          <div class="prev-works" bis_skin_checked="1">
            <span class="dots"></span>
            <div class="img-holder" bis_skin_checked="1">
              <img alt="img" src="<?php bloginfo('template_url'); ?>/assets/img/works1-1.jpg">
            </div>
          </div>
        </div>
        <div class="slide" bis_skin_checked="1">
          <div class="prev-works" bis_skin_checked="1">
            <span class="dots"></span>
            <div class="img-holder" bis_skin_checked="1">
              <img alt="img" src="<?php bloginfo('template_url'); ?>/assets/img/works1-2.jpg">
            </div>
          </div>
        </div>
        <div class="slide" bis_skin_checked="1">
          <div class="prev-works" bis_skin_checked="1">
            <span class="dots"></span>
            <div class="img-holder" bis_skin_checked="1">
              <img alt="img" src="<?php bloginfo('template_url'); ?>/assets/img/works1-3.jpg">
            </div>
          </div>
        </div> -->
        <?php
...
?>
      ...
      <ul class="brend">
        <li>
          <img alt="img" src="<?php bloginfo('template_url'); ?>/assets/img/google.svg"></li>
          <li>
    ...
    <div class="col-holder" bis_skin_checked="1">
      ...
      <div class="col" bis_skin_checked="1">
        <div class="img-holder" bis_skin_checked="1">
          <img alt="img" src="<?php bloginfo('template_url'); ?>/assets/img/img-form.png"></div>
        </div>
      </div>
    </div>
    <div class="left-white" bis_skin_checked="1"></div>
    <div class="right-white" bis_skin_checked="1"></div>
  </section></main><div class="contact-popup" bis_skin_checked="1">
    <div class="popup-text" bis_skin_checked="1"><div class="anim-holder" bis_skin_checked="1">
